...
const states = {
	 ...
	 * @property {number} 108 - @fan_power_108@
	 */
	fan_power: {
		101: "Quiet",
		102: "Balanced",
 ...
 * @property {string} switch_map_mode - @switch_map_mode@
 * @property {string} charge_status - @charge_status@
 * @property {string} avoid_count - @avoid_count@
 * @property {string} collision_avoid_status - @collision_avoid_status@
 * @property {string} clean_percent - @clean_percent@
 */
const deviceStatus = {
	unsave_map_flag: {
 ...
 * @property {Object} avoid_count - @avoid_count@
 */
